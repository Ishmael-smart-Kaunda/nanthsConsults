...
export default function Blog(){
                        return(
                               <>
                                    <section className="p-5 md:px-25 w-full">
                                        <h1 className="text-center text-4xl md:text-8xl  font-bold text-black py-50">Latest updates to be here</h1>
                                        
                                        
                                        <div className=" hidden grid grid-cols-1 p-5 gap-6">
