    ...
    return(
             <section className="w-full p-5 md:px-25 max-w-[1440px] space-y-4 bg-gray-400">
                <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-10 ">
                    <div className="space-y-6 bordr border-black/40 p-5 px-10 rounded-xl bg-gray-600/20">
                     ...
                     <div className=" space-y-6 bg-gray-200 p-5 px-10 rounded-xl shadow-md shadow-gray-600 ">
