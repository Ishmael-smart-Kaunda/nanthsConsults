...
import { PiAtomLight, PiClock, PiMedalLight, PiSealCheck, PiTimerLight } from "react-icons/pi";
    ...
    return(
           <section className="w-full max-w-[1440px] p-5 md:px-25">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-15">          
                        <div className="md:b space-y-10">
                            <h1 className="w-full py-2 border-b text-[30px] font-bold "> Our Company</h1>
                            <h3 className="text-3xl font-light ">Guided By <br/> Purpose. Driven <br/>  By People</h3>
                        </div>
                            <div className="w-full px-2 relaxed">
                                <p className="text-[22px] font-light py-5">
                 ...
                 {/* CORE VALUES */}
                 <h2 className="font text-[25px] my-10">Our Core Values</h2>
                <div className="w-full grid grid-cols-1 md:grid-cols-4 gap-6">
                    <article className="h-full border border-blue-600/50 bg-blue-600/10 space-y-3 p-5">
                            <div className="size-fit rounded-full bg-blue-600 p-2 "> <PiMedalLight className="size-6 ext-black"/></div>
                            <h3 className="font-semibold text-[20px]">Quality </h3>
                            <p>Our excellence in service delivery leads to distinct output.</p>
                    </article>
                    <article className="h-full border border-emerald-600/50 bg-emerald-600/10 space-y-3 p-5">
                            <div className="size-fit rounded-full bg-emerald-600 p-2 "> <PiSealCheck className="size-6 ext-black"/></div>
                    ...
                    <article className="h-full border border-violet-600/50 bg-violet-600/10  space-y-3 p-5">
                            <div className="size-fit rounded-full bg-violet-600 p-2 "> <PiAtomLight className="size-6 ext-black"/></div>
                    ...
                    <article className="h-full border border-amber-500/50 bg-amber-600/10  space-y-3 p-5">
                            <div className="size-fit rounded-full bg-amber-500 p-2 "> <PiClock className="size-6 ext-black"/></div>
                ...
                {/*MISSION AND VISION */}
                 <div className="grid grid-cols-1 gap-6 md:grid-cols-2 my-20">
                    ...
                    <div className="w-full h-full bg-ascent"></div>


                </div> 

                 {/* VALUE PROPOSITION*/}
                 <h2 className="font text-[25px] my-10">Why Us</h2>
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="w-full px-2 font-light">
                                <h1 className="text-[19px]">Explore factors defining  our difference.</h1>
                                {/*<hr/>
                                <p className="text-center">Below are the reasons why we are a step closer to your HR and Administration solutions</p>*/}
                                <article className="space-y-2 my-6">
                                        <span className="inline-flex items-center gap-2 font-semibold"><FaCheckDouble className="text-emerald-500"/>Custom-made Solutions </span>
                                ...
                                <article className="space-y-2 my-6">
                                        <span className="inline-flex items-center gap-2 font-semibold"><FaCheckDouble className="text-emerald-500"/> Client first</span>
                                ...
                                <article className="space-y-2 my-6">
                                        <span className="inline-flex items-center gap-2 font-semibold"><FaCheckDouble className="text-emerald-500"/>Value for Money</span>
