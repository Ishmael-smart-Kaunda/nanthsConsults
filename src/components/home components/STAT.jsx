...
export default function STAT(){
               return(
                        <section className="w-full max-w-[1440px] h-fit px-5 md:px-25 py-3 my-10  roundedxl">
                                <div className="gap-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 md:flex-row items-center justify-between">
                                    <div className=" w-full h-60  p-8 flex flex-col align-center gap-1 text-white bg-black border border-amber-900/20 rounded-md">
