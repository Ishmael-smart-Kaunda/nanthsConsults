...
export default function Partners(){
                        return(
                               <section className="w-full max-w-[1440px] md:py-25 px-5 md:px-25">
                                ...
                                <div className=" mt-20 flex  flex-row w-full shrink-0 items-center overflow-auto flex-nowrap gap-10">
                                    <figure className="min-w-60   py-2 px-3   font-semibold"> 
                                        
                                        <img src={client1} alt="" className="w h-auto" />
                                        <figcaption className="text-center -translate-y-5 ">Capita Bank</figcaption> 
                                    </figure>
                                    <figure className="min-w-60  py-2 px-3 rounded-[22px]  font-semibold"> 
